...
public class TSonDeath{
	...
	public TSonDeath() {
		forward 	= getImage("/imgs/"+"TSonDeath.png"); //load the image for Tree
...
//		}
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = TSonDeath.class.getResource(path);
