...
public class RockScroll2{
	...
	double scaleWidth = .8;		//change to scale image
	double scaleHeight = .79; 		//change to scale image

	public RockScroll2() {
		forward 	= getImage("/imgs/"+"Rock2.png"); //load the image for Tree
	...
	public RockScroll2(int x, int y) {
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = RockScroll2.class.getResource(path);
