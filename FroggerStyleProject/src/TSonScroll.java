...
public class TSonScroll{
	...
	int dir = 2; 					//0-forward, 1-backward, 2-left, 3-right
	int width, height;
	...
	public TSonScroll() {
		forward 	= getImage("/imgs/"+"TSon.png"); //load the image for Tree
	...
	public boolean collided(SpaceMarine character) {
		...
		Rectangle thisObject = new Rectangle(x, y+18, width, height);
	...
	public void paint(Graphics g) {
		...
		if(Frame.debugging) {
			...
			g.drawRect(x, y+18, width, height);
		}
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = TSonScroll.class.getResource(path);
