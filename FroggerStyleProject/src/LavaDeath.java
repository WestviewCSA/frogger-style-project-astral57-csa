...
public class LavaDeath{
	...
	public LavaDeath() {
		forward 	= getImage("/imgs/"+"LavaDeath.png"); //load the image for Tree
...
//		}
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = LavaDeath.class.getResource(path);
