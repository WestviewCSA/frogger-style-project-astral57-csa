...
public class TyranidDeath{
	...
	public TyranidDeath() {
		forward 	= getImage("/imgs/"+"TyranidDeath.png"); //load the image for Tree
	...
	public TyranidDeath(int x, int y) {
...
//		}
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = TyranidDeath.class.getResource(path);
